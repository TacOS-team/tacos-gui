...
\frame{
  ...
  \begin{block}{Window}
    \begin{itemize}
      ...
      \item Les objets Window forment un arbre n-aire, l'ordre des fils d'une fenêtre détermine leur profondeur à l'intérieur de cette fenêtre
...
\frame{
  ...
  \begin{block}{Librairie cliente de pron}
    \begin{itemize}
      \item Permet aux applications d'interagir avec le serveur graphique :
      \begin{itemize}
        \item Connexion
        \item Création et gestion des fenêtres
        \item Dessin
