...
ENUM_OR_STRING( RQ_DRAW_RECT ),               \
ENUM_OR_STRING( RQ_FILL_RECTANGLE ),          \
ENUM_OR_STRING( RQ_DRAW_CIRCLE ),	      \
ENUM_OR_STRING( RQ_FILL_CIRCLE ),	      \
ENUM_OR_STRING( RQ_GET_WINDOW_ATTRIBUTES ),   \
ENUM_OR_STRING( RQ_SET_WINDOW_ATTRIBUTES ),   \
ENUM_OR_STRING( RQ_SELECT_INPUT ),            \
ENUM_OR_STRING( RESP_WELCOME ),               \
ENUM_OR_STRING( RESP_WINDOW_ATTRIBUTES ),     \
ENUM_OR_STRING( EVENT_WINDOW_CREATED ),       \
ENUM_OR_STRING( EVENT_POINTER_MOVED )
